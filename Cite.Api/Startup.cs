...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddScoped<IScoringModelRoleService, ScoringModelRoleService>();
    ...
    {
        app.UseMiddleware<Cite.Api.Infrastructure.Exceptions.Middleware.ExceptionMiddleware>();
